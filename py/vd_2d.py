...
def draw_arrow(_list, _color = 'black' ,_line_style = 'solid', _alpha = 0.5, _line_width = 1) :
    """ draw arrow.
    ...
    for i in range(len(_list)) :
        ...
        plt.annotate('', xy=(end_x, end_y), xytext = (start_x, start_y),  arrowprops={'edgecolor': _color, 
                                                                                      'facecolor': 'red', 
                                                                                      'alpha' : _alpha, 
                                                                                      'arrowstyle' : '-|>, head_length = 1, head_width = 0.7',  
...
if __name__ == '__main__' :
    ...
    delaunay    = read_edge(delaunay_path)
    ...
    # ----------------------------------------- generator
    draw_coordinate(faces, 'blue', 700)
    
    # ----------------------------------------- vd edges
    # draw_line(edges, _line_width=2)
    
    # ----------------------------------------- delaunay
    draw_line(delaunay, 'red', _line_width=2, _line_style=":")
    
    # ----------------------------------------- mst
    draw_line(mst, _line_width= 2)
    
    # ----------------------------------------- odd faces
    # draw_coordinate(odd_face, 'red', 800)
    
    # ----------------------------------------- odd mpm
    # draw_line(odd_mst,'red', _line_style = ":", _line_width = 5)
    
    # ----------------------------------------- euler path
    # draw_line(euler)
    # draw_arrow(euler, _alpha = 1, _line_width = 4)
     
    # ----------------------------------------- hamiltonian path
    # draw_line(hamiltonian, _line_width = 2)
    ...
    for i in range(len(faces)) :
        for j in range(i+1, len(faces)) :
            all_line.append([])
            all_line[-1].append(faces[i][0])
            all_line[-1].append(faces[i][1])
            all_line[-1].append(faces[j][0])
            all_line[-1].append(faces[j][1])
    # draw_line(all_line, _line_width = 2)
