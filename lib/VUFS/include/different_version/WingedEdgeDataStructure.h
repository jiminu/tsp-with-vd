...
{
private:
    typedef WingedEdgeDataStructure::Edge   Edge;
    typedef WingedEdgeDataStructure::Vertex Vertex;
...
public:
    ...
    void    set_first_edge(const Edge* const edge);

    bool    is_incident_to(const Vertex* const vertex) const;
    bool    is_incident_to(const Edge* const edge) const;
    bool    is_adjacent_to(const Face* const face) const;
    ...
    rg_INT  find_bounding_vertices( list<Vertex*>& boundingVertices) const;
    rg_INT  find_bounding_edges(    list<Edge*>&   boundingEdges) const;
    rg_INT  find_adjacent_faces(    list<Face*>&   adjacentFaces) const;
};
...
///////////////////////////////////////////////////////////////////////////////
//
// inline functions for class WingedEdgeDataStructure 
//
...
///////////////////////////////////////////////////////////////////////////////
//
// inline functions for class WingedEdgeDataStructure::Face 
//
...
///////////////////////////////////////////////////////////////////////////////
//
// inline functions for class WingedEdgeDataStructure::Edge 
//
...
///////////////////////////////////////////////////////////////////////////////
//
// inline functions for class WingedEdgeDataStructure::Vertex 
//
