...
/*                        polynomial                              */  
/*                flag    flag = rg_TRUE  => complex coefficients    */
...
/*rg_INT      *n;     the highest exponent of the original polynomial */
/*rg_REAL   *maxerr; max. error of all determined roots             */ 
/*unsigned char flag;  flag = rg_TRUE  => complex coefficients        */
/*                     flag = rg_FALSE => real    coefficients        */
{
     rg_REAL   newerr; /* error of actual root                      */
     dcomplex ns;     /* root determined by Muller's method        */
     rg_INT      nred,   /* highest exponent of deflated polynomial   */
              i;      /* counter                                   */
...
/*         *root;  determined roots                                */
/*rg_INT      *nred,  highest exponent of the deflated polynomial     */
/*         *n;     highest exponent of the original polynomial     */
{
     rg_INT  i = -1, /* i stores the (reduced) real degree            */
          j;      /* counter variable                              */
     unsigned char
           notfound=rg_TRUE; /* indicates, whether a coefficient      */
...
/*rg_INT      *n;     the highest exponent of the original polynomial */
{
     rg_REAL factor;   /* stores absolute value of the coefficient  */
                      /* with highest exponent                     */
     rg_INT    i;        /* counter variable                          */
