...
/***** Complex(a,b) create complex number with real part a and *****/
/***** imaginary part b and return result                      *****/
dcomplex Complex(rg_REAL a,rg_REAL b)
{
     dcomplex c;
...
rg_REAL Cabs(dcomplex z)
{
     rg_REAL x,y,ans,temp;
...
dcomplex RCmul(rg_REAL x,dcomplex a)
{
     dcomplex c;
...
/***** RCadd(x,a) add real x and complex a and return result *****/
dcomplex RCadd(rg_REAL x,dcomplex a)
{
     dcomplex c;
