...
rg_BOOL Interval_REAL::isInIntervalWithOpenOpenEnd(const rg_REAL& value) const
{
...
rg_BOOL Interval_REAL::isInIntervalWithOpenCloseEnd(const rg_REAL& value) const
{
...
rg_BOOL Interval_REAL::isInIntervalWithCloseOpenEnd(const rg_REAL& value) const
{
    if ( m_lowerValue == m_upperValue )  {
        if ( m_lowerValue == value )
            return rg_TRUE;
...
rg_BOOL Interval_REAL::isInIntervalWithCloseCloseEnd(const rg_REAL& value) const
{
    if ( (m_lowerValue <= value) && (value <= m_upperValue ) )
        return rg_TRUE;
    else
