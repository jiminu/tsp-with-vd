...
QuasiTriangulation2D::QuasiTriangulation2D(void)
{
}
...
/*
void QuasiTriangulation2D::construct(CircleVoronoiDiagram& circleSetVD)
{
...
void QuasiTriangulation2D::construct(CircleSetVoronoiDiagram& circleSetVD)
{
    VertexQT2D** mappingTableFromFaceInVD2VertexInQT = createAndInitializeVerticesInQT2D( circleSetVD);
    FaceQT2D**   mappingTableFromVertexInVD2FaceInQT = createAndinitializeFacesInQT2D(    circleSetVD);
...
void QuasiTriangulation2D::construct( VoronoiDiagram2DC& circleSetVD )
{
...
void QuasiTriangulation2D::getFacesIncidentToVertex(VertexQT2D* vertex, rg_dList<FaceQT2D*>& faceList) const
{
...
void QuasiTriangulation2D::getBoundingVerticesOfFace(FaceQT2D* face, rg_dList<VertexQT2D*>&  vertexList) const
{
...
void QuasiTriangulation2D::getNeighboringFacesOfFace(FaceQT2D* face, rg_dList<FaceQT2D*>&    faceList) const
{
...
void QuasiTriangulation2D::getBoundingVerticesOfFace(FaceQT2D* face, VertexQT2D** vertexArray) const
{
    VertexSCDS** vertices = face->getVertices();
...
void QuasiTriangulation2D::getNeighboringFacesOfFace(FaceQT2D* face, FaceQT2D**   faceArray) const
{
    FaceSCDS** neighbors = face->getNeighbors();
...
/*
VertexQT2D** QuasiTriangulation2D::createAndInitializeVerticesInQT2D(CircleVoronoiDiagram& circleSetVD)
{
...
VertexQT2D** QuasiTriangulation2D::createAndInitializeVerticesInQT2D(CircleSetVoronoiDiagram& circleSetVD)
{
	rg_INT             numFacesInVD = circleSetVD.getNumFaces();
...
void QuasiTriangulation2D::createAndInitializeVerticesInQT2D(VoronoiDiagram2DC& circleSetVD, map<const VFace2D*, VertexQT2D*>& mappingTableFromFaceInVD2VertexInQT)
{
	...
	for(; it_vFaces != VFaces.end(); it_vFaces++) {
		...
		if ( currVFace->isInfinite()) {
            ...
            // Modified by CYSONG at July16, 2020.
...
/*
FaceQT2D** QuasiTriangulation2D::createAndinitializeFacesInQT2D(CircleVoronoiDiagram& circleSetVD)
{
...
FaceQT2D** QuasiTriangulation2D::createAndinitializeFacesInQT2D(CircleSetVoronoiDiagram& circleSetVD)
{
	rg_INT               numVerticesInVD = circleSetVD.getNumVertices();
...
// 2014-04-15 JKKIM ADDED ///////////////////////////////////////////////////////////////////
void   QuasiTriangulation2D::createAndinitializeFacesInQT2D(   VoronoiDiagram2DC& circleSetVD, map<const VVertex2D*, FaceQT2D*>& mappingTableFromVertexInVD2FaceInQT)
{
...
/*
void QuasiTriangulation2D::setTopologyBetweenVerticesAndTetrahedraInQT(CircleVoronoiDiagram& circleSetVD,
...
void QuasiTriangulation2D::setTopologyBetweenVerticesAndTetrahedraInQT(CircleSetVoronoiDiagram& circleSetVD,
                                                                       VertexQT2D** mappingTableFromFaceInVD2VertexInQT,
                                                                       FaceQT2D**   mappingTableFromVertexInVD2FaceInQT)
{
    rg_INT i=0;
...
// 2014-04-15 JKKIM ADDED ///////////////////////////////////////////////////////////////////
void QuasiTriangulation2D::setTopologyBetweenVerticesAndTetrahedraInQT( VoronoiDiagram2DC& circleSetVD, 
