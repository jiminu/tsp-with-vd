...
Generator2D* BucketForDisks::findGoodCloseGenerator( const rg_Point2D& pt )
{
    int xIndexOfGenerator = 0;
    int yIndexOfGenerator = 0;
...
void BucketForDisks::getBucketCellIndexForPoint( const rg_Point2D& pt, int& xIndex, int& yIndex )
{
