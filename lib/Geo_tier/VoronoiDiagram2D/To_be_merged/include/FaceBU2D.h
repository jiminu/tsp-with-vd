...
public:
    ...
    rg_BOOL isAdjacentTo( const FaceBU2D* const face ) const;
    rg_BOOL isIncidentTo( const EdgeBU2D* const edge ) const;
    rg_BOOL isIncidentTo( const VertexBU2D* const vertex ) const;
