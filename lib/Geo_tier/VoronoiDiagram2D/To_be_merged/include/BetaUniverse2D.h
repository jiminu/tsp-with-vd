...
public:
    ...
    void construct(QuasiTriangulation2D_GEO& QT2D);
    void clean();
...
private:
    void convert(QuasiTriangulation2D_GEO& QT2D);
        void createAndInitializeFacesInBU2D( QuasiTriangulation2D_GEO& QT2D,    map<FaceSCDS*, FaceBU2D*>&     mappingTableFromFaceInQTToFaceInBU );
        void createAndInitializeVerticesInBU2D( QuasiTriangulation2D_GEO& QT2D, map<VertexSCDS*, VertexBU2D*>& mappingTableFromVtxInQTToVtxInBU );
